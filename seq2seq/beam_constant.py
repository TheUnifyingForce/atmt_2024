...
class BeamSearch(object):
    def __init__(self, beam_size, max_len, pad):
        ...
        self.completed_nodes = []  # New: track completed nodes (EOS)
    ...
    def add_final(self, score, node):
        ...
        # Mark node as completed but keep it in the active nodes
        node.completed = True
    ...
    def get_current_beams(self):
        ...
        while not self.nodes.empty() and len(nodes) < self.beam_size:
            ...
            # Continue expanding even completed nodes
    ...
    def prune(self):
        ...
        # Ensure constant beam size by keeping some finished nodes in the beam
